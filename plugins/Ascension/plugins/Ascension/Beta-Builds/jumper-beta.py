...
def main():
    ...
    if task_action == "wipe":
        ...
        # Fetch detailed performer info including name, rating, custom fields, and image_path
        ...
        try:
            ...
            for performer in performers_details:
                export_data["performers"].append({
                    ...
                    "ID": performer.get("id"),  # Added performer ID to export
                    ...
                    "image_path": performer.get("image_path")  # Added image_path to export
                })
